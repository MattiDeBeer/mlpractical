...
required_columns = {'train_acc', 'val_acc'}
...
plt.plot(data['train_acc'], label=txt_name + ' train acc')
plt.plot(data['val_acc'], label=txt_name + ' val acc')
plt.xlabel("Epoch")
plt.ylabel("Accuracy")
plt.title("Training and Validation Accuracy per Epoch")
plt.legend()
acc_plot_path = os.path.join(plots_folder, f"{input_filename}_acc_plot.pdf")
